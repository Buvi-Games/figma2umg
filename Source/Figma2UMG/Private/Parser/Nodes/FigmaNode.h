...
public:
	...
	void CreatePaintAssetBuilderIfNeeded(const FString& InFileKey, TArray<TScriptInterface<IAssetBuilder>>& AssetBuilders, const TArray<FFigmaPaint>& InFills) const;
