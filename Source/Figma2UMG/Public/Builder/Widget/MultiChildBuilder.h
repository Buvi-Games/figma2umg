...
public:
	...
	virtual void PatchAndInsertWidget(TObjectPtr<UWidgetBlueprint> WidgetBlueprint, const TObjectPtr<UWidget>& WidgetToPatch, TMap<FString, int32>& NameTracker) override PURE_VIRTUAL(UMultiChildBuilder::PatchAndInsertWidget());
...
protected:
	...
	virtual void PatchAndInsertChildren(TObjectPtr<UWidgetBlueprint> WidgetBlueprint, const TObjectPtr<UPanelWidget>& ParentWidget, TMap<FString, int32>& NameTracker);
